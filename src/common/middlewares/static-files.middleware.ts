...
export class StaticFilesMiddleware {
    private static allowedDomains = ['http://127.0.0.1:5500/', 'http://192.168.1.128:5501/', 'http://192.168.1.49:3000/', 'http://192.168.1.55:3000/', 'https://gdgroup.vn/', 'https://admin.gdgroup.vn/', 'https://gdgroup.vn', 'https://admin.gdgroup.vn'];
